...
const ContactUs = () => {
  return (
    <div className="m-0 flex w-full flex-col items-end md:flex-row">
      ...
      <div className="flex w-full flex-col gap-10 p-20 pr-0 text-center md:mb-10 md:w-1/2 md:text-left">
        ...
        <div className="flex justify-center gap-10 px-6 md:justify-start">
          <Button text="Email" width="12" />
          <Button text="WhatsApp" width="12" />
        </div>
      </div>
      ...
      <div className="relative h-96 w-1/2 md:visible">
        <Image
          ...
          layout="fill"
          objectFit="cover"
          src="/contact-us.svg" // Replace with your image path
        />
      </div>
    </div>
    // </div>
